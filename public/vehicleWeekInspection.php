<?php
require 'auth.php';
if (!in_array($authRole, $vehicleInspectionsRoles) && $authUser->email!="nikola.kontic@360monte.me") {
    header('HTTP/1.0 403 Forbidden');
    header('Location: /403');
    exit();
}

if(isset($_SESSION['weekly_inspection_vehicle_id'])
    || isset($_SESSION['weekly_inspection_date'])
){
    $showFilters = '';
    $clearFilters = '';
        ...
        <div class="page-container">
            <div class="main-content">
                <div class="page-header">
                    <h2 class="header-title">Nedeljni izvještaji (inspekcija vozila) </h2>
                    <div class="header-sub-title">
                        <nav class="breadcrumb breadcrumb-dash">
                            <a href="/" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Početna</a>
                            <span class="breadcrumb-item active">Nedeljni izvještaji</span>
                        </nav>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="m-t-25">
                            ...
                            <button type="button" class="btn btn-primary m-b-15 m-r-10" id="showWeeklyInspectionFilter" >
                                Filteri
                            </button>
                            <div class="card" id="filterWeeklyInspection" style="<?=$showFilters?>">
                                <div class="card-body">
                                    <h4>Filteri</h4>
                                    <input type="hidden" id="weekly_inspection_vehicle_id" value="<?php echo isset($_SESSION['weekly_inspection_vehicle_id']) ? $_SESSION['weekly_inspection_vehicle_id'] : '' ?>">
                                    <input type="hidden" id="weekly_inspection_date" value="<?php echo isset($_SESSION['weekly_inspection_date']) ? $_SESSION['weekly_inspection_date'] : '' ?>">
                                ...
                                <div class="card-footer">
                                    <div class="text-right">
                                        ...
                                        <button class="btn btn-primary" id="weeklyInspectionsFilter">Filtritaj</button>
                                    </div>
                                </div>
                            </div>

                            <input id="reportType" value="1" hidden="">
...
<script src="/assets/js/vehicleInspection.js?v=2304"></script>
</body>
